...
`;
    ...
    class Advection extends ShaderPass {
      ...
      dispose() {
        ...
        if (this.line) {
          ...
          if (this.line.material) (this.line.material as THREE.RawShaderMaterial).dispose();
        }
      }
    }
    ...
    class ExternalForce extends ShaderPass {
      ...
      dispose() {
        ...
        if (this.mouse) {
          ...
          if (this.mouse.material) (this.mouse.material as THREE.RawShaderMaterial).dispose();
        }
      }
    }
    ...
    class Output {
      ...
      dispose() {
        ...
        if (this.output) {
          ...
          if (this.output.material) (this.output.material as THREE.RawShaderMaterial).dispose();
        }
      }
    }
  ...
  return (
    <div
      ref={mountRef}
      className={`w-full h-full overflow-hidden pointer-events-none touch-none ${className || ''}`}
      style={style}
    />
  );
}